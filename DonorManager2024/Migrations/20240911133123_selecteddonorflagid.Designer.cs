...
namespace DonorManager2024.Migrations
{
    ...
    [Migration("20240911133123_selecteddonorflagid")]
    partial class selecteddonorflagid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DonorDonorFlags", b =>
                {
                    b.Property<int>("DonorFlagsFlagId")
                        .HasColumnType("int");

                    b.Property<int>("DonorsDonorId")
                        .HasColumnType("int");

                    b.HasKey("DonorFlagsFlagId", "DonorsDonorId");

                    b.HasIndex("DonorsDonorId");

                    b.ToTable("DonorDonorFlags");
                });

            modelBuilder.Entity("DonorFlagsTransactions", b =>
                {
                    b.Property<int>("DonorFlagsFlagId")
                        .HasColumnType("int");

                    b.Property<int>("TransactionsTransId")
                        .HasColumnType("int");

                    b.HasKey("DonorFlagsFlagId", "TransactionsTransId");

                    b.HasIndex("TransactionsTransId");

                    b.ToTable("DonorFlagsTransactions");
                });
            ...
            modelBuilder.Entity("DonorManager.Models.Donor", b =>
                {
                    ...
                    b.Property<int>("SelectedDonorFlagId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DonorManager2024.Models.MailGroup.CCRoster", b =>
                {
                    b.Property<int>("CCRosterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CCRosterId"));
                    ...
                    b.Property<string>("MName1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MName2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DonorManager2024.Models.MailGroup.Nixies", b =>
                {
                    b.Property<int>("NixieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NixieId"));
                    ...
                    b.Property<string>("Middle1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Middle2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Suffix1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Suffix2")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DonorManager2024.Models.MailGroup.NoMail", b =>
                {
                    b.Property<int>("NoMailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NoMailId"));
            ...
            modelBuilder.Entity("DonorManager2024.Models.UsersRelated.Users", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DonorDonorFlags", b =>
                {
                    b.HasOne("DonorManager2024.Models.DonorRelated.DonorFlags", null)
                        .WithMany()
                        .HasForeignKey("DonorFlagsFlagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DonorManager.Models.Donor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DonorFlagsTransactions", b =>
                {
                    ...
                    b.HasOne("DonorManager2024.Models.Transactions", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DonorManager2024.Models.MailGroup.NoMail", b =>
                {
                    ...
                    b.HasOne("DonorManager2024.Models.UsersRelated.Users", "Users")
                        .WithMany()
